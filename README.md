...
Because of this change, RxBluetoothKotlin was updated to fire the `NeedBluetoothPermission` exception at the right moment when the fine permission is missing starting from the release `3.1.0`.
